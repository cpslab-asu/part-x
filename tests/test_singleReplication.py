...
# def test1_single_replication(oracle_info:OracleCreator):
...
# def test2_single_replication(oracle_info:OracleCreator):
...
def test3_single_replication(oracle_info:OracleCreator, data_path: pathlib.Path):
...
def test4_single_replication(oracle_info:OracleCreator, data_path: pathlib.Path):
    ...
    t = time.time()
    run_single_replication(inputs)
    with open("./tests/optimizer/Testing_t4_result_generating_files/Testing_t4_0.pkl", "rb") as f:
        ftree = pickle.load(f)
