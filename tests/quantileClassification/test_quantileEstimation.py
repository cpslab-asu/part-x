...
class TestQuantileEstimation(unittest.TestCase):
    def test1_mc_step(self):
        ...
        min_quantile, max_quantile = mc_step(x_train, y_train, region_support, tf_dim, alpha, R, M, gpr_model, rng, sampling_type = "lhs_sampling")
    ...
    def test2_mc_step(self):
        ...
        min_quantile, max_quantile = mc_step(x_train, y_train, region_support, tf_dim, alpha, R, M, gpr_model, rng, sampling_type = "uniform_sampling")
