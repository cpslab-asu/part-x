...
def save_trees_plots(ftree, options):
    ...
    node_id = []
    points_class = []
    ax.set_ylim(options.init_reg_sup[0,0], options.init_reg_sup[0,1])
    ax.set_xlim(options.init_reg_sup[1,0], options.init_reg_sup[1,1]) 
    ...
    plt.savefig("test_img_1.png", dpi = 400, bbox_inches = 'tight')
